...
This [Drone](https://drone.io/) plugin allows you to use `helm` without messing around with the authentication
...
Inspired by [drone-kubectl](https://github.com/sinlead/drone-kubectl).
